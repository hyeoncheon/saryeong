...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { partial: @widget.partial, system: @widget.system, x: @widget.x, y: @widget.y }
    end
  ...
  test "should update widget" do
    patch :update, id: @widget, widget: { partial: @widget.partial, system: @widget.system, x: @widget.x, y: @widget.y }
    assert_redirected_to widget_path(assigns(:widget))
  end
